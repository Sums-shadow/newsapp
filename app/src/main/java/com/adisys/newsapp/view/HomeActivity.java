...
public class HomeActivity extends AppCompatActivity implements CategoryRVAdapter.categoryClickInterface {
    ...
    private void getAllCategories(){
        ...
        categoryRVModels.add(new CategoryRVModel("Politique","https://img.freepik.com/photos-gratuite/details-colonne-marbre-gris-batiment_1359-886.jpg?t=st=1654075567~exp=1654076167~hmac=9f48ab2a8221805d9abdd1461f8e4a001553e70bd5ac5d21268f6a083c26e247&w=740"));
        categoryRVModels.add(new CategoryRVModel("Academique","https://img.freepik.com/photos-gratuite/groupe-multiethnique-jeunes-hommes-femmes-etudiant-interieur_1139-989.jpg?t=st=1654083422~exp=1654084022~hmac=d662d1a5eac21936b7bb2795c4672a91fb1f5bfe8a630d448b1b92e810168c8a&w=740"));
        categoryRVModels.add(new CategoryRVModel("Social","https://img.freepik.com/photos-gratuite/gens-dans-concert_1160-737.jpg?t=st=1654083190~exp=1654083790~hmac=44eb4c46b280ee9ce66f0d1cbf0a5ed87b45a1d44d694a77ed011481c1560822&w=740"));
        categoryRVModels.add(new CategoryRVModel("Economique","https://img.freepik.com/photos-gratuite/pile-pieces-argent-graphique-trading_1150-17752.jpg?t=st=1654083248~exp=1654083848~hmac=d77e3034c8542d8f4748a0f1e86e80aadd9bde6fb31a40adbefe96a29b71a5b3&w=740"));
        categoryRVModels.add(new CategoryRVModel("Environnement","https://img.freepik.com/photos-gratuite/chemin-terre-au-milieu-arbres-forestiers-journee-ensoleillee_181624-2875.jpg?t=st=1654083462~exp=1654084062~hmac=1310ce5227108c8f8cfa6fb7345b0dd3b36704030875cc349e0848efd7277137&w=740"));
        categoryRVModels.add(new CategoryRVModel("Santé","https://img.freepik.com/free-photo/close-up-african-american-hand-holding-stethoscope_482257-19507.jpg?t=st=1654075352~exp=1654075952~hmac=cef087bd7049a670c9dbd7faf69f990bd7579e56cf832e4e65c0b300ecfe3ff4&w=740"));
    ...
    private void getNews(String category){
        ...
        String categoryUrl= "http://newsapi.org/v2/top-headlines?country=cd&category=" + category + "&apiKey=7c9fc2de96cb40d795dd2cae9653c8a1";
        ...
        Call<NewsModel> call=retrofitApi.getAllNews(allUrl);
